...
namespace AutomationTests.PageObjects.staging.juiceplus.com.ie.en.CompletePage
{
    class CompletePageObjects
    {
        ...
        [OpenQA.Selenium.Support.PageObjects.FindsBy(How = How.XPath, Using = "//a[@href='https://www.staging.juiceplus.com/ie/en/products/complete/shakes/vanilla-shakes']//span[@class='a-button__inner']")]
        public IWebElement ShakesShopNowComplete { get; set; }

        [OpenQA.Selenium.Support.PageObjects.FindsBy(How = How.XPath, Using = "//a[@href='https://www.staging.juiceplus.com/ie/en/products/complete/bars/chocolate-bars']//span[@class='a-button__inner']")]
        public IWebElement JuiceBarsShopNowComplete { get; set; }

        [OpenQA.Selenium.Support.PageObjects.FindsBy(How = How.XPath, Using = "//a[@href='https://www.staging.juiceplus.com/ie/en/products/complete/vegetable-soup']//span[@class='a-button__inner']")]
        public IWebElement VegetableSoupShopNowComplete { get; set; }

        [OpenQA.Selenium.Support.PageObjects.FindsBy(How = How.XPath, Using = "//a[@href='https://www.staging.juiceplus.com/ie/en/products/complete/complete-combi-box/vanilla-shake-combi-box']//span[@class='a-button__inner']")]
        public IWebElement CombiBoxShopNowComplete { get; set; }

        [OpenQA.Selenium.Support.PageObjects.FindsBy(How = How.XPath, Using = "//a[@href='https://www.staging.juiceplus.com/ie/en/products/complete/booster']//span[@class='a-button__inner']")]
