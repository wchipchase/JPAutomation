...
namespace AutomationTests.PageActions.towergarden.com.CheckoutActions
{
    class CheckoutActions
    {
        public static void InputShippingAndBillingInfo(String firstName, String lastName, String phoneNumber, String emailAddress, String address, String zip, String city, String state, String country, Boolean sameBillingInformation, String repType)
        {
            ...
            {
                Thread.Sleep(1000);
                CheckoutPage.RefferingWebAdYesRadio.Click();
            }
        }
        ...
        public static void ZipLookup(String zip, String city)
        {
            ...
            CheckoutPage.CitySelectProceedButton.Click();
